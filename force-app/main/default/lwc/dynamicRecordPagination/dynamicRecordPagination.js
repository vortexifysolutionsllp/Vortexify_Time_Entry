...
export default class DynamicRecordPagination extends LightningElement {
    @api list;
    currentPage = "1";
    @api contactChunks;
    contactToDisplay;
   ...
   @api
                ...
                if(this.list.length == 100){
                    ...
                    if(this.total == 1 && this.list.length < 100){
                        ...
                        if(this.list.length == 10){
                            ...
                            this.pageParameterEnd = this.pageParameterStart + (this.list.length - 1) ;
                            this.noOfRecords = this.pageParameterEnd;
    ...
    handleNext() {
        ...
        if (parseInt(this.currentPage) > this.totalPages) {
            ...
            this.lastRecordName = lastRecord != null ? lastRecord.commentNumber : null;
    ...
    handlePrev() {
        ...
        if (parseInt(this.currentPage) < "1") {
            ...
            this.firstRecordName = firstRecord != null ? firstRecord.commentNumber : null;
   ...
   handleFirst() {
    ...
    requestMoreRecords() {
        ...
        let event = new CustomEvent('requestmore', {
            detail: {
    ...
    requestPreviousRecords() {
        debugger;
        this.total = this.total - 1;
        let event = new CustomEvent('requestpreviousrecords', {
            detail: {
